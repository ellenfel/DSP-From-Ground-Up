...
#define SIG_LENGTH 550

extern double _501pts_20Hz_sig_imx[501];
extern double _501pts_20Hz_sig_rex[501];
                 ...
                 int sig_length)
{
    ...
    for(int k = 0; k < sig_length-1; k++)
    {
        for(int i=0;i<sig_length-1;i++)
        {
            ...
            sig_dest_freq_domain_imx[k] = sig_dest_freq_domain_imx[k] + sig_src_time_domain_rex[i] * SI + sig_src_time_domain_imx[i] * SR;
        }
    }
